...
export function MessageGenerator(params: Params, tamplate: TTamplateConfig):string{
    ...
    function ParamsFilter(params: Params, tamplateParams: string[]): Params{
    ...
    // Compose strings
    function Compose(params: Params, tamplate: TTamplateStruct):string{
        ...
        if (tamplate.IFBlocks){
            ...
            Compose(params, tamplate.IFBlocks.Then):
